...
public class BrutForceSolutionFinderImpl implements SolutionFinder {
	...
	/**
	 * Recursion - take a partially filled grid, a nonempty deck.
	 * Take a card from the deck and try to fit it into the next empty slot on the grid.
	 * If the card fits, recurse further. If not, return an empty list.
	 */
	@Override
